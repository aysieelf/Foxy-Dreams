...
GAME_OVER_CURRENT_SCORE_TEXT = "SCORE:"
GAME_OVER_CURRENT_SCORE_FONT_SIZE = 20
GAME_OVER_CURRENT_SCORE_FONT = "courier new"
GAME_OVER_CURRENT_SCORE_TEXT_COLOR = STAR_PARTICLES_COLOR
GAME_OVER_CURRENT_SCORE_P1_POS = (60, 20)
GAME_OVER_CURRENT_SCORE_P2_POS = (WIDTH - 200, 20)

# GAME OVER TOP SCORES
TOP_SCORES_TEXT = "TOP SCORES"
TOP_SCORES_FONT_SIZE = 20
TOP_SCORES_FONT = "courier new"
TOP_SCORES_TEXT_COLOR = WARM_GREY
TOP_SCORES_POS = (WIDTH // 2, HEIGHT // 2 - 50)

# TOP SCORES RECTANGLE
TOP_SCORES_RECT_POS = (WIDTH // 2, HEIGHT // 2 + 40)
# PATHS -----------------------------------------------------------------------
